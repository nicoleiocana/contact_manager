...
describe 'the person view', type: :feature do
  ...
  describe 'email addresses' do
    before(:each) do
      person.email_addresses.create(address: "first@example.com")
      person.email_addresses.create(address: "second@example.com")
    ...
    it 'has an add email address link' do
      expect(page).to have_link('New email address', href: new_email_address_path(contact_id: person.id, contact_type: 'Person'))
    end
